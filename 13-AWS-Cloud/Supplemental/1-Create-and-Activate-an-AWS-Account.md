...
2. In the left menu of the "Billing" section, choose "Billing preferences," next enable the "Receive Free Tier Usage Alerts" option and type the e-mail address where you want to receive the usage alerts. Also, enable the "Receive Billing Alerts" option to receive a notification of your spending on AWS. Click on the "Save preferences" button to finish.
