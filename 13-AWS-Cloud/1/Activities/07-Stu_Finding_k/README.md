...
2. Scale the data by using the `StandardScaler` module to normalize the DataFrame values.
   ...
   > **Hint:** You can recall how to use the `StandardScaler` in [this article](https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.StandardScaler.html) of the Scikit-learn documentation.
